...
Given to an individual with a demonstrated history of experience in the field who embodies the Zephyr Principles and mission. Criteria:

- Selflessly contributed to the good of the industry through the body of their work
- Collegial and collaborative, investing in shared technical knowledge and community assets
- Generous with their time through mentorship and other volunteer roles
...
Given to a project with potential for a positive impact on the field, meeting the majority of the following criteria:

- Implemented, adopted, or applied in practice at least once
- Methodology, formula, or design freely accessible to the public
...
Given to a project with a *proven* positive impact on the field, meeting the majority of the following criteria:

- Broadly adopted or implemented in practice
- Improved the approach, skills, or capability of the decision-making process
- Methodology, formula, or design freely accessible to the public
- Promotes multilateral collaboration
- Advances the travel analysis field for the public good
