...
additional-msg: <b><u>Summary Notes Now Posted</b></u><br>Scroll down and expand a project to read the full notes from what each team came up with at TRB.
...
<details markdown="1">
<summary><strong>Reproducible Research</strong></summary>
...
- **Templates** — an Ethics template (a Template IRB proposal people can take and throw into their own IRB) and an NDA template (language people write into NDAs is often too strict).
- **Use Foundation money to replicate important research** — has been done in other fields; hard to get people to replicate research if nobody is publishing papers on the replication. Could alternatively fund a prize for finding problems in something important.
- **Peer reviews.**
- **Example projects** — the Foundation could give money to get a repository with good documentation and a wiki; more valuable to the community, and could turn around the priority to give an incentive to the professor to look at the documentation.
- **Establish reproducibility standards** — should Zephyr encourage journals to require reproducibility? Require at least pseudo-code, which is usually more readable than creating well-documented "real" code. Precedents for sharing actual code exist: in physical science publishing, a code within an operable context is part of the process, and social science data is often messy, so having operational code or at least standardized inputs is important.

</details>

<details markdown="1">
<summary><strong>Before and After Studies</strong></summary>
...
#### What are different stakeholders' needs and motivations?
...
<details markdown="1">
<summary><strong>Community-owned Travel Modeling Software</strong></summary>
...
<details markdown="1">
<summary><strong>Exploring Uncertain Topics</strong></summary>
...
<details markdown="1">
<summary><strong>Model vs Model</strong></summary>
...
#### What goals should this initiative have?
...
<details markdown="1">
<summary><strong>Count Dracula's Lab</strong></summary>
...
<details markdown="1">
<summary><strong>General Travel Network Specification</strong></summary>
...
<details markdown="1">
<summary><strong>Improved Data Standards and Data Management</strong></summary>
